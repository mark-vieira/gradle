...
<<custom_plugins.adoc#sec:getting_input_from_the_build,project extensions>> or <<variant_aware_plugins.adoc#implementing_artifact_transforms,artifact transforms>>,
