        ...
        public void doValidate(String propertyName, Object value, TaskValidationContext context) {
            ...
            if (!file.exists()) {
                if (Files.isSymbolicLink(file.toPath())) {
                    LOGGER.info("File '{}' specified for property '{}' is a broken symbolic link.", file, propertyName);
                } else {
        ...
        public void doValidate(String propertyName, Object value, TaskValidationContext context) {
            ...
            if (!directory.exists()) {
                if (Files.isSymbolicLink(directory.toPath())) {
                    LOGGER.info("Directory '{}' specified for property '{}' is a broken symbolic link.", directory, propertyName);
                } else {
